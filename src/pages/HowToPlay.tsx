  ...
  const sections = [
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">
            Nexus Syndicates is a strategic trading and territory control game
            set in a cyberpunk metaverse. As a player, you'll lead your own
          ...
          <ol className="list-decimal pl-5 space-y-2 mb-4">
            <li>
              Connect your wallet using the Aptos Wallet Connect button in the
              top-right corner.
            </li>
            <li>
              Create your character by selecting a username and faction on the
              Profile page.
            </li>
            <li>
              Explore the Dashboard to understand the game's main components.
            </li>
          ...
          <div className="cyber-panel p-4 mb-4">
            ...
            <p>
              Start by securing a few territories close to each other. This will
              create a strong base of operations and make it easier to defend
              your holdings.
            </p>
          </div>
        </>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">
            The digital world of Nexus Syndicates is divided into hexagonal
            territories, each with unique resources and strategic value.
          ...
          <ol className="list-decimal pl-5 space-y-2 mb-4">
            <li>
              Navigate to the Game Map and select an unclaimed territory (shown
              in green).
            </li>
            <li>Deploy a defense agent to secure the territory.</li>
            <li>
              Wait for the claiming process to complete (approximately 24
              hours).
            </li>
            <li>
              Once claimed, the territory will generate resources every cycle (8
              hours).
            </li>
          </ol>
        </>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">
            AI Agents are your digital workforce, performing tasks autonomously
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">
            The economy of Nexus Syndicates revolves around four primary
          ...
          <div className="space-y-4 mb-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm">
                  Advanced materials. Used for defense systems, infrastructure,
                  and high-tier upgrades.
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">
            Syndicates are player-formed organizations that work together to
            control larger portions of the network. Joining or forming a
